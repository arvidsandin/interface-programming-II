 ...
 void level1(){
  ...
  void tutorialLevel(){
    this.level = new GameObject[]{
      ...
      new GameObject("rectangle", 4900, 300, 150, 100, color(123, 132, 123)), // Low rectangle
      new GameObject("rectangle", 5400, 125, 600, 200, color(123, 132, 183)), // Floating platform
      ...
      new TextObject(5400, -75, color(255), new String[] {"Jump over gaps", "Hoppa över gap"}),
