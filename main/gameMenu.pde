...
public class GameMenu implements Menu{
  ...
  String[][] btnTexts = new String[][]{{"CONTINUE", "SETTINGS", "CHOOSE LEVEL", "MAIN MENU"}, {"FORTSÄTT", "INSTÄLLNINGAR", "VÄLJ NIVÅ", "HUVUDMENY"}, {"SIGUE", "OPCIONES", "ELIGE NIVEL", "MENU PRINCIPAL"}};
